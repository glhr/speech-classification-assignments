...
# using a fully connected vs convolutional architecture and SGD vs Adam optimizer.
...
## train the model
trainer = pl.Trainer(devices=1, max_epochs=50, log_every_n_steps=1, deterministic=True) # define the training configuration
